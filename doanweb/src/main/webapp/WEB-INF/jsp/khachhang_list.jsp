...
<div class="container">
    <table class="table table-striped">
        ...
        <c:forEach items="${khachHangList}" var="khachhang" >
            <tr>
                ...
                <td>
                    <spring:url value="/khachhang/updateKhachHang/${khachhang.makh}" var="updateURL" />
                    <a class="btn btn-primary" href="${updateURL }" role="button" >Update</a>
                </td>
                <td>
                    <spring:url value="/khachhang/deleteKhachHang/${khachhang.makh }" var="deleteURL" />
    ...
    <spring:url value="/khachhang/addKhachHang/" var="addURL" />
